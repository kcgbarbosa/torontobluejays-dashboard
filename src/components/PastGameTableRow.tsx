    ...
    >
      ...
      <td className="px-2 py-2.5 sm:px-4 sm:py-3 min-w-0 sm:text-center">
        <div className="flex items-center gap-2 text-sm sm:justify-center">
          <div
            className={`flex items-center gap-1.5 ${awayWon ? 'font-bold text-gray-900' : 'text-gray-400'}`}
          >
            <img
          ...
          <div
            className={`flex items-center gap-1.5 ${homeWon ? 'font-bold text-gray-900' : 'text-gray-400'}`}
          >
            <img
